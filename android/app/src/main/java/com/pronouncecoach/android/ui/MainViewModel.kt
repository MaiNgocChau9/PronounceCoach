...
import com.pronouncecoach.android.PronounceCoachApp
import com.pronouncecoach.android.audio.AudioRecorder
import com.pronouncecoach.android.data.PhonemeEntry
import com.pronouncecoach.android.data.DrillSorter
import com.pronouncecoach.android.data.WordDatabase
import com.pronouncecoach.android.data.WordItem
import com.pronouncecoach.android.ml.EspeakWrapper
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val pipeline = (application as PronounceCoachApp).pipeline
    ...
    fun startDrill(entry: PhonemeEntry) {
        viewModelScope.launch {
            val items = withContext(Dispatchers.Default) {
                ...
                val vi = com.pronouncecoach.android.data.Prefs.language(getApplication()) == "vi"
